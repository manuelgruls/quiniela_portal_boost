...
!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["http-post-message"]=t():e["http-post-message"]=t()}(self,(()=>(()=>{"use strict";var e={};return(()=>{var t=e;Object.defineProperty(t,"__esModule",{value:!0}),t.HttpPostMessage=void 0;var o=function(){function e(e,t,o){void 0===t&&(t={}),this.defaultHeaders=t,this.defaultTargetWindow=o,this.windowPostMessageProxy=e}return e.addTrackingProperties=function(e,t){return e.headers=e.headers||{},t&&t.id&&(e.headers.id=t.id),e},e.getTrackingProperties=function(e){return{id:e.headers&&e.headers.id}},e.isErrorMessage=function(e){return"number"==typeof(e&&e.statusCode)&&!(200<=e.statusCode&&e.statusCode<300)},e.prototype.get=function(e,t,o){return void 0===t&&(t={}),void 0===o&&(o=this.defaultTargetWindow),this.send({method:"GET",url:e,headers:t},o)},e.prototype.post=function(e,t,o,r){return void 0===o&&(o={}),void 0===r&&(r=this.defaultTargetWindow),this.send({method:"POST",url:e,headers:o,body:t},r)},e.prototype.put=function(e,t,o,r){return void 0===o&&(o={}),void 0===r&&(r=this.defaultTargetWindow),this.send({method:"PUT",url:e,headers:o,body:t},r)},e.prototype.patch=function(e,t,o,r){return void 0===o&&(o={}),void 0===r&&(r=this.defaultTargetWindow),this.send({method:"PATCH",url:e,headers:o,body:t},r)},e.prototype.delete=function(e,t,o,r){return void 0===t&&(t=null),void 0===o&&(o={}),void 0===r&&(r=this.defaultTargetWindow),this.send({method:"DELETE",url:e,headers:o,body:t},r)},e.prototype.send=function(e,t){if(void 0===t&&(t=this.defaultTargetWindow),e.headers=this.assign({},this.defaultHeaders,e.headers),!t)throw new Error("target window is not provided.  You must either provide the target window explicitly as argument to request, or specify default target window when constructing instance of this class.");return this.windowPostMessageProxy.postMessage(t,e)},e.prototype.assign=function(e){for(var t=[],o=1;o<arguments.length;o++)t[o-1]=arguments[o];if(null==e)throw new TypeError("Cannot convert undefined or null to object");var r=Object(e);return t.forEach((function(e){if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t])})),r},e}();t.HttpPostMessage=o})(),e})()));
...
// SIG // n+T3s8epKSwHcL2qMl1/W3H1nOKsVEZ6s5L5hSKNvVyg
...
// SIG // BDEiBCBxsODhAVWW/cug/Z2QKmbiGWw+S3mQgpfDcViK
// SIG // jPqarjBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMA
// SIG // cgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNyb3Nv
// SIG // ZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBALiNZFKMTVdV
// SIG // 8YgJCKJjgshiRp/neOG9wPIN6sQW8PauLseBo8I4N0cl
// SIG // CLKOmdG/iZBjBNrVfnmHRHKXStx/0G9vMbhcUquLaasA
// SIG // dK8Gxh6fL2v/xohBj7mHJd56mCX46MbSst2ePBm1xCQB
// SIG // TduOqj83tc/42wop90XXjIKn6rhHhA1y32orDbDRFpgE
// SIG // ftxB0UIc8o7H4Xe+AnJ14mMSAavDwOhOdsyphqCgIQG8
// SIG // xcAmWBc/K/T1M9bE3H+1HuXdmJbTibPKfc+05Rn9+shD
// SIG // OH8l6jCd67hUoJYSmrLVpWm2Ea7S8rxc3N6GG4kDnBh6
// SIG // ezSrtdfuWoGeKwjdYQ3F7gahghcpMIIXJQYKKwYBBAGC
...
// SIG // BglghkgBZQMEAgEFAAQgKqixsE9Ljzpm408U0xU7oSK1
// SIG // reb8o0RJBAu4eVy+XvECBmZy9bCk+RgTMjAyNDA3MTIw
// SIG // MDEyMTAuMDQ5WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UE
...
// SIG // AQQwLwYJKoZIhvcNAQkEMSIEIDAh1Pwaq7ntIutMect7
// SIG // lxHMdEM9OT6nIBc0jAHGbh21MIH6BgsqhkiG9w0BCRAC
...
// SIG // eBUyX0zfEjANBgkqhkiG9w0BAQsFAASCAgBRoSOS8Ywa
// SIG // 9EuKRjGJMZf8totj4xpV0gcR9nyDLmhlYeHnQdFhu5Ko
// SIG // jTvIQv1s+NdDfrugr70yHktT3H4H1r2gaETSUds9B5Ig
// SIG // 9c5rk16ISV+Y+ReHYEh7IN+PZLyPI0STJFfoLY0rK8fe
// SIG // uZVTiwCBNH/C/HGM03AhgKJ8NZ7Oyf2Kq60zXi/AhGQS
// SIG // Yk39Na8Ny+NysbJFdTye2iDKRGH9CBnByrS8N/Rz/+AW
// SIG // 3xuQPttD1Neaf/OZOya354+ix/PQ2d8SbkGcQaPr3MAf
// SIG // 1erxWViw2LnvS4KhYr8yMEqtXbaJZIQ9otjOs7Nk4hAr
// SIG // ZfQ/i1RF9lbfWHVMdDFdxaQNmy30XkoHtNoanCk33miU
// SIG // mxXYxPzdteDNfMrn1255x1G9vSq/IEWfc0Ml9NB5JzqZ
// SIG // cFyufN7YT2OMwNiVO4KF8GIjEMZss8L8JoE4nHSqCPDR
// SIG // UHnSnt1xIpGMBl9tudlHA4kwkvujfMAXfN6mCkA/URRw
// SIG // D2ExwPnL+rhJFuGMT9nLmxH6hR/xwila6255Hx8FO7rT
// SIG // 85M/uNioBr9ZLwZ+cw+IRHFTH6oXFFSwVWKS+XerywCn
// SIG // F+jpqG58uPRr5toYO0EzEqxmmtzY2lteENUs4+WH6pnl
// SIG // LNEu4+f3fUr+NsaxoVRO19Rwage0YmIHa7G1ZAHFnl6O
// SIG // 2RactSw+3Ua8og==
