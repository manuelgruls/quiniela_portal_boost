...
!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["http-post-message"]=t():e["http-post-message"]=t()}(self,()=>(()=>{"use strict";var e,t={};return e=t,Object.defineProperty(e,"__esModule",{value:!0}),e.HttpPostMessage=void 0,o.addTrackingProperties=function(e,t){return e.headers=e.headers||{},t&&t.id&&(e.headers.id=t.id),e},o.getTrackingProperties=function(e){return{id:e.headers&&e.headers.id}},o.isErrorMessage=function(e){return"number"==typeof(e&&e.statusCode)&&!(200<=e.statusCode&&e.statusCode<300)},o.prototype.get=function(e,t,o){return void 0===o&&(o=this.defaultTargetWindow),this.send({method:"GET",url:e,headers:t=void 0===t?{}:t},o)},o.prototype.post=function(e,t,o,r){return void 0===r&&(r=this.defaultTargetWindow),this.send({method:"POST",url:e,headers:o=void 0===o?{}:o,body:t},r)},o.prototype.put=function(e,t,o,r){return void 0===r&&(r=this.defaultTargetWindow),this.send({method:"PUT",url:e,headers:o=void 0===o?{}:o,body:t},r)},o.prototype.patch=function(e,t,o,r){return void 0===r&&(r=this.defaultTargetWindow),this.send({method:"PATCH",url:e,headers:o=void 0===o?{}:o,body:t},r)},o.prototype.delete=function(e,t,o,r){return void 0===r&&(r=this.defaultTargetWindow),this.send({method:"DELETE",url:e,headers:o=void 0===o?{}:o,body:t=void 0===t?null:t},r)},o.prototype.send=function(e,t){if(void 0===t&&(t=this.defaultTargetWindow),e.headers=this.assign({},this.defaultHeaders,e.headers),t)return this.windowPostMessageProxy.postMessage(t,e);throw new Error("target window is not provided.  You must either provide the target window explicitly as argument to request, or specify default target window when constructing instance of this class.")},o.prototype.assign=function(e){for(var t=[],o=1;o<arguments.length;o++)t[o-1]=arguments[o];if(null==e)throw new TypeError("Cannot convert undefined or null to object");var r=Object(e);return t.forEach(function(e){if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t])}),r},e.HttpPostMessage=o,t;function o(e,t,o){this.defaultHeaders=t=void 0===t?{}:t,this.defaultTargetWindow=o,this.windowPostMessageProxy=e}})());
// SIG // Begin signature block
// SIG // MIIr5QYJKoZIhvcNAQcCoIIr1jCCK9ICAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // e6wj98HpUg8rw7nCo9JtHWZKfkIws94EGpvWRZhPFMqg
...
// SIG // BDEiBCC2kaNiW80EJmjHzGpLnDNO8n5L2QSTP5PClq9W
// SIG // U6e0QjBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMA
// SIG // cgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNyb3Nv
// SIG // ZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAI3Ej+0Nd+Cm
// SIG // u8V8bsmFvJ1ep0OInA1v66ipRsC6Engtrdq1mM2yGJvA
// SIG // HA5uTqLW2M4wF9iF972cJbrmOanmM/CFfhXyFCjPLZoI
// SIG // Ut94vSgzwlYcrg6BF0GQORTT0DEgLKf+os8RnpfhizMS
// SIG // T527AbGTyWGeOYZndTG5Ta73FMSdyyZpBQ7E91F5l7PN
// SIG // uR9k2fjJ4FY80HdsA8X3m64wfWyQGdPYVwsf/uh4YOFf
// SIG // ToMv/rK8Uz/+wOue9lTOotbNprNgduR7uWzVSxrd3Z6t
// SIG // f7psmTCHUr2RuEMnqKcMbSzMmhXtaqVUCfZYEn1mHrWc
// SIG // vKuutVPySHYQiu4vldA1xCihgheXMIIXkwYKKwYBBAGC
...
// SIG // BglghkgBZQMEAgEFAAQglHQG3nbYTj3LHntPcfm10dq2
// SIG // mqzWKps4KnMqz+d8FOYCBmaIKzNRuRgTMjAyNDA3MTIw
// SIG // MDEyMTAuMDE1WjAEgAIB9KCB0aSBzjCByzELMAkGA1UE
...
