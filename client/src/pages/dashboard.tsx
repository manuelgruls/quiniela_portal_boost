        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 h-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full content-stretch">
              ...
              <Card className="rounded-2xl border border-primary/40 shadow-[0_0_15px_-3px_hsl(var(--primary)/0.15)] hover:border-primary hover:shadow-[0_0_20px_-5px_hsl(var(--primary)/0.4)] hover:-translate-y-1 transition-all duration-300 h-full overflow-hidden">
                <div className="bg-gradient-to-br from-card to-primary/5 h-full">
                  <CardHeader>
